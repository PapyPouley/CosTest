<template>
   <div class="amplifier">
      <div class="header-row">
         <h1 class="header-text">Microphone Test Results</h1>
         <div class="image" @click="runTest">
            <img src="@/assets/icons/Run.png" class="img" />
            <p>Run</p>
         </div>
         <div class="data">
            <dataBase :data="results" type="microphone" @loaded="loadHandler" />
         </div>
      </div>
   ...
   methods: {
      ...
      async runTest() {
         ...
         if (resConnection.error) {
            ...
            let results = await testAudio("microphone");
            this.results = results;
            //  Print the results
            this.printGraph(this.results.microphone)
         }
      },
      printGraph(results) {
         if (results) {
